...
const projects: Project[] = [
  {
    ...
    github: "{GITHUB_URL}/ai-debate-arena",
  },
  {
    title: "CV-Analyser",
  ...
  },
  {
    ...
    github: "{GITHUB_URL}/chessbot-vision-system",
  },
];
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                {project.tech.slice(0, 4).map((t) => (
                  <span key={t} className="text-xs px-2 py-0.5 rounded-full border border-border/60 text-muted-foreground">
                    {t}
                  </span>
                ))}
        ...
        <AnimatePresence>
          {activeProject !== null && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
            >
              <div className="absolute inset-0 bg-background/80 backdrop-blur-sm" onClick={() => setActiveProject(null)} />
              <motion.div
                className="glass-card p-6 sm:p-8 max-w-lg w-full relative z-10 border-primary/20"
